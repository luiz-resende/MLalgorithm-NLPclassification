...
kSVC = SVC(kernel='poly', C=10, degree=3, gamma='auto', probability=True, tol=0.001, max_iter=100, decision_function_shape='ovr', cache_size=500, verbose=1,
           random_state=None)
...
if(SINGLE):
    ...
    HeldOutDataPredictions = Clf.predict(vec_testing)
